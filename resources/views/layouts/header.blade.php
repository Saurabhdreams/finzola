            ...
            @if (Auth::user()->dark_mode)
                <a href="javascript:void(0)" data-turbo="false" title="{{ __('messages.switch_to_light_mode') }}"
                   style="transition: color 0.3s ease;">
                       <svg width="25px" class="text-primary fs-2 apply-dark-mode" height="25px" viewBox="0 0 24 24"
                         fill="#6571ff" xmlns="http://www.w3.org/2000/svg"
                         onmouseover="this.querySelector('path').style.fill='#ffeb3b';"
                         onmouseout="this.querySelector('path').style.fill='#6571ff';">
                        <path fill="#6571ff" d="M12 3V4M12 20V21M4 12H3M6.31412 6.31412L5.5 5.5M17.6859 6.31412L18.5 5.5M6.31412 17.69L5.5 18.5001M17.6859 17.69L18.5 18.5001M21 12H20M16 12C16 14.2091 14.2091 16 12 16C9.79086 16 8 14.2091 8 12C8 9.79086 9.79086 8 12 8C14.2091 8 16 9.79086 16 12Z"
                              stroke="#6571ff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                </a>
            @else
                <a href="javascript:void(0)" data-turbo="false" title="{{ __('messages.switch_to_dark_mode') }}"
                   style="transition: fill 0.3s ease;">
                    <svg width="25px" class="text-primary fs-2 apply-dark-mode" height="25px" viewBox="0 0 24 24"
                         ...
                         onmouseover="this.querySelector('path').style.fill='#ffeb3b';"
                         onmouseout="this.querySelector('path').style.fill='#6571ff';">
                         <path fill="#6571ff" stroke="#6571ff" stroke-linecap="round" stroke-linejoin="round"
        ...
        <li class="px-xxl-3 px-2">
            <div class="dropdown custom-dropdown d-flex align-items-center py-4">
                <button class="btn dropdown-toggle hide-arrow p-0 position-relative" type="button"
                    ...
                    <svg width="25px" class="fa-solid fa-bell text-primary fs-2" height="25px" viewBox="0 0 24 24"
                         fill="#6571ff" xmlns="http://www.w3.org/2000/svg"
                         onmouseover="this.querySelector('path').style.fill='#ffeb3b';"
                         onmouseout="this.querySelector('path').style.fill='#6571ff';">
                        <path fill="#6571ff" d="M12 3V4M12 20V21M4 12H3M6.31412 6.31412L5.5 5.5M17.6859 6.31412L18.5 5.5M6.31412 17.69L5.5 18.5001M17.6859 17.69L18.5 18.5001M21 12H20M16 12C16 14.2091 14.2091 16 12 16C9.79086 16 8 14.2091 8 12C8 9.79086 9.79086 8 12 8C14.2091 8 16 9.79086 16 12Z"
                        ...
                        @if (session('impersonated_by'))
                            <li>
                                <a class="dropdown-item text-gray-900 position-relative cursor-pointer"
                                    href="{{ route('impersonate.userLogout') }}" data-turbo="false">
                                    <span class="dropdown-icon me-4 text-gray-600">
