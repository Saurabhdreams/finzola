        ...
        <div class="row align-items-center justify-content-center">
            <div class="col-xl-6">
                <div class="copyright text-center text-muted">
                     &copy; {{ date('Y') }} <span class="font-weight-bold ml-1">{{ $settingValue['app_name']['value'] }}. All rights reserved. 1XL Info LLP
                    <p>A product by <a href="https://1xl.com/" target="blank">1XL.com</a></p>
