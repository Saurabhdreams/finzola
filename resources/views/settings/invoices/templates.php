<script id="defaultTemplate" type="text/x-jsrender">
    ...
    <div class="container-fluid">
        <div class="mb-8">
            <img width="100px" src="<?php echo getLogoUrl() ?>" alt="logo-image">
        </div>
    ...
    <div class="preview-main client-preview">
        <div class="d" id="boxes">
            ...
            <table style="width:75%;" class="mb-8">
                <tr>
                   <td class="w-50" style="vertical-align: top; padding-right: 10px;">
                   ...
                   <td class="w-50" style="vertical-align: top; padding-left: 10px;">
        ...
        <div class="d" id="boxes">
            <div class="d-inner">
             ...
             <div class="overflow-auto">
                ...
                <div class="bottom-border mt-2" style="background-color: {{:invColor}};"></div>
            </div>
        </div>
    </div>
</script>
