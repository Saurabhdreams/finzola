            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-6 mb-5">
                        ...
                        {{ Form::text('invoice_no_prefix', $settings['invoice_no_prefix'], ['class' => 'form-control', 'placeholder' => __('messages.setting.invoice_no_prefix'), 'maxlength' => '50', 'pattern' => '[0-9]+', 'title' => 'Please enter numbers only']) }}
                    </div>
                    <div class="form-group col-sm-6 mb-5">
                    ...
                    <div class="form-group col-sm-6 mb-5">
                        ...
                        {{ Form::text('invoice_no_suffix', $settings['invoice_no_suffix'], ['class' => 'form-control', 'placeholder' => __('messages.setting.invoice_no_suffix'), 'maxlength' => '50', 'pattern' => '[0-9]+', 'title' => 'Please enter numbers only']) }}
                    </div>
                    <div class="form-group col-sm-6 mb-5">
