<div class="row gx-10 mb-5">
    ...
    <div class="col-lg-6">
        <div class="mb-5 position-relative">
            ...
            {{ Form::email('email', $client->user->email ?? null, ['class' => 'form-control form-control-solid search-email edit-time-search user-email', 'id' => 'editUserEmail', 'required', 'placeholder' => __('messages.client.email'), 'autocomplete' => 'off']) }}
    ...
    <div class="col-lg-6">
        <div class="mb-5">
            ...
            {{ Form::tel('contact', $client->user->contact ?? '', ['class' => 'form-control form-control-solid user-contact-number','required', 'placeholder' => __('messages.client.contact_no'), 'onkeyup' => 'if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,"")', 'id' => 'phoneNumber']) }}
    ...
    <div class="col-md-6 mb-5">
        <div class="fv-row">
            <div>
                {{ Form::label('password', __('messages.client.password') . ':', ['class' => 'form-label required mb-3']) }}
    ...
    <div class="col-lg-6">
        <div class="mb-5">
            ...
            {{ Form::text('postal_code', $client->postal_code ?? null, ['class' => 'form-control form-control-solid postal-code', 'placeholder' => __('messages.client.postal_code'), 'required', 'pattern' => '[0-9]+', 'title' => 'Please enter numbers only']) }}
        </div>
    </div>
    <div class="col-lg-4">
        <div class="mb-5">
    ...
    <div class="col-xl-3 col-lg-4">
        <div class="mb-5">
            ...
            {{ Form::text('vat_no', $client->vat_no ?? null, ['class' => 'form-control form-control-solid', 'placeholder' => $vatNoLabel, 					'pattern' => '^[A-Z0-9]{15}$', 'title' => 'Please enter a valid GSTIN (15 alphanumeric characters)']) }}
        </div>
    </div>
