<div class="row gx-10 mb-5">
    ...
    <div class="col-lg-6">
        <div class="mb-5 position-relative">
            ...
            {{ Form::text('email', null, ['class' => 'form-control form-control-solid search-email user-email','required', 'placeholder' => __('messages.client.email'), 'autocomplete' => 'off']) }}
    ...
    <div class="col-xl-3 col-lg-4">
        <div class="mb-5">
           ...
           {{ Form::text('vat_no', null, [
				'class' => 'form-control form-control-solid vat-no',
				'placeholder' => $vatNoLabel,
				'pattern' => '^[A-Z0-9]{15}$',
				'title' => 'Please enter a valid GSTIN (15 alphanumeric characters)'
			]) }}
